...
class Rectangle:
    ...
    @property
    def width(self):
        """Geting and setting of width of the Rectangle."""
        return self.__width
    ...
    @property
    def height(self):
        """Geting and setting of height of the Rectangle."""
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Returns of Rectangle with the greater area.
        Args:
