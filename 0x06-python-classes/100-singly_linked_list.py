#!/usr/bin/python3
"""For a single link list classes"""
...
class SinglyLinkedList():
    """for SinglyLinkedList class"""
    def __init__(self):
        """Stating SinglyLinkedList"""
        self.__head = None

    def sorted_insert(self, DataValue):
        """Insertion of a nodes"""
    ...
    def __str__(self):
        """This is for the class of a string"""
        strg = ""
        actual = self.__head
        while actual:
